...
Alquileres {
	...
	id_plan integer *> Planes_de_Alquiler.id_plan
...
Usuarios {
	...
	id_participaciones integer >* Participaciones.id_participacion
}
...
Estados_de_disponibilidad_de_las_bicicletas {
	id_estado_de_disponibilidad integer pk increments unique
	nombre varchar unique
...
Personas {
	...
	tipo_de_persona integer null *> Tipos_de_persona.id_tipo_de_persona
	fecha_de_registro date
}
...
Tipos_de_persona {
	id_tipo_de_persona integer pk increments unique
...
estados_fisicos_tomados_por_la_bicicleta {
	...
	id_estado_mantenimiento integer *> estados_fisicos_de_las_bicicletas.id_estado_mantenimiento
...
disponibilidades_tomadas_por_las_bicicletas {
	id_bicicleta integer *> Bicicletas.id_bicicleta
	id_estado_de_disponibilidad integer *> Estados_de_disponibilidad_de_las_bicicletas.id_estado_de_disponibilidad
	fecha_inicio_estado datetime
	fecha_fin_estado datetime
}
